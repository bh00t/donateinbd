...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UserProfile.person_occupation'
        db.delete_column(u'donation_userprofile', 'person_occupation')

        # Deleting field 'UserProfile.account_type'
        db.delete_column(u'donation_userprofile', 'account_type')

        # Deleting field 'UserProfile.org_identification_doc'
        db.delete_column(u'donation_userprofile', 'org_identification_doc')

        # Deleting field 'UserProfile.org_website'
        db.delete_column(u'donation_userprofile', 'org_website')

        # Deleting field 'UserProfile.org_description'
        db.delete_column(u'donation_userprofile', 'org_description')

        # Deleting field 'UserProfile.person_file'
        db.delete_column(u'donation_userprofile', 'person_file')

        # Adding field 'UserProfile.occupation'
        db.add_column(u'donation_userprofile', 'occupation',
                      self.gf('django.db.models.fields.CharField')(max_length=40, null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.description'
        db.add_column(u'donation_userprofile', 'description',
                      self.gf('django.db.models.fields.CharField')(max_length=40, null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.website'
        db.add_column(u'donation_userprofile', 'website',
                      self.gf('django.db.models.fields.CharField')(max_length=400, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'UserProfile.person_occupation'
        db.add_column(u'donation_userprofile', 'person_occupation',
                      self.gf('django.db.models.fields.CharField')(max_length=40, null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.account_type'
        db.add_column(u'donation_userprofile', 'account_type',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=40, blank=True),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'UserProfile.org_identification_doc'
        raise RuntimeError("Cannot reverse this migration. 'UserProfile.org_identification_doc' and its values cannot be restored.")
        # Adding field 'UserProfile.org_website'
        db.add_column(u'donation_userprofile', 'org_website',
                      self.gf('django.db.models.fields.CharField')(max_length=400, null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.org_description'
        db.add_column(u'donation_userprofile', 'org_description',
                      self.gf('django.db.models.fields.CharField')(max_length=40, null=True, blank=True),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'UserProfile.person_file'
        raise RuntimeError("Cannot reverse this migration. 'UserProfile.person_file' and its values cannot be restored.")
        # Deleting field 'UserProfile.occupation'
        db.delete_column(u'donation_userprofile', 'occupation')

        # Deleting field 'UserProfile.description'
        db.delete_column(u'donation_userprofile', 'description')

        # Deleting field 'UserProfile.website'
        db.delete_column(u'donation_userprofile', 'website')
