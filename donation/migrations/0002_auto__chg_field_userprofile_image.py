...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'donation_userprofile', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'UserProfile.image'
        db.alter_column(u'donation_userprofile', 'image', self.gf('django.db.models.fields.files.FileField')(max_length=100))
