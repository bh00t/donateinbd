...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Report.header'
        db.add_column(u'donation_report', 'header',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Report.header'
        db.delete_column(u'donation_report', 'header')
    ...
    models = {
        ...
        u'donation.report': {
            ...
            'header': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
