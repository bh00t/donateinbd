...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Report.amount_spent'
        db.add_column(u'donation_report', 'amount_spent',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Report.amount_spent'
        db.delete_column(u'donation_report', 'amount_spent')
    ...
    models = {
        ...
        u'donation.report': {
            ...
            'amount_spent': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True'}),
