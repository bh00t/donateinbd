...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Message.sender_full_name'
        db.add_column(u'donation_message', 'sender_full_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Message.sender_full_name'
        db.delete_column(u'donation_message', 'sender_full_name')
